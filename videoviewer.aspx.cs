...
public partial class Default4 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            videoid = new Guid(Request.QueryString["videoid"]);
        }
        catch { }
    }
    protected void SqlDataSource1_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
    {
        e.Command.Parameters["@VideoID"].Value = videoid;
    }
    ...
    protected void ListView1_ItemCommand(object sender, ListViewCommandEventArgs e)
    {
        ...
        if (String.Equals(e.CommandName, "allcomment"))
        {
            ...
            postId = post_id;
            PostCommentDataSource.SelectCommand = "SELECT * FROM [VideoComments] WHERE ([VideoID] = '" + videoid + "') ORDER BY [CommentDate]";
    ...
    protected void ListViewPostComment_ItemInserting(object sender, ListViewInsertEventArgs e)
    {
        ...
        postKey = new Guid(((Label)lvi.FindControl("VideoIDLabel")).Text);
        ...
        string insertSql = "INSERT INTO VideoComments(Comment, VideoID, CommentUser, CommentUserId,CommentUserName) VALUES(@Comment, @VideoID, @CommentUser, @CommentUserId,@CommentUserName)";
        ...
        using (SqlConnection myConnection = new SqlConnection(connectionString))
        {
            ...
            myCommand.Parameters.AddWithValue("@VideoID", postKey);
