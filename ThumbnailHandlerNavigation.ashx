...
public class ThumbnailHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            sqlcmd = new System.Data.SqlClient.SqlCommand("select ProfilePicture from UserProfiles where UserName='" + context.Request.QueryString["userid"] + "'", conn);
            conn.Open();
            ...
            while (rdr.Read())
            {
                ...
                System.Drawing.Image thumbnailImage = image.GetThumbnailImage(45, 45, new System.Drawing.Image.GetThumbnailImageAbort(ThumbnailCallback), IntPtr.Zero);
