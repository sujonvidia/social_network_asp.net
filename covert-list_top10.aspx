<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="covert-list_top10.aspx.cs" Inherits="Default5" %>
...
<br /></span>
          ...
          <td runat="server" >&nbsp;&nbsp;</td>
           ...
           <asp:SqlDataSource ID="CovertDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SecurityConnectionString %>" OnSelecting="CovertDataSource_Selecting" SelectCommand="SELECT TOP 10 * FROM [CovertPosts] WHERE ([LikeCount] &gt; @LikeCount) ORDER BY LikeCount DESC">
               <SelectParameters>
                   <asp:Parameter DefaultValue="0" Name="LikeCount" />
               </SelectParameters>
        </asp:SqlDataSource>
