<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="videoviewer.aspx.cs" Inherits="Default4" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <ContentTemplate>
   ...
   <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID,LikeId,VideoID,CommentId" DataSourceID="SqlDataSource1"  OnItemCreated="ListView1_ItemCreated" OnItemCommand="ListView1_ItemCommand">
            ...
            <div class="colelem post_section" style="margin-top: -25px;padding: 5px;">
               ...
               <ItemTemplate>
                   ...
                   <span>
                       ...
                       <asp:Label ID="UserIdLabel" runat="server" Text='<%# Eval("UserId") %>' Visible="false" />
                           <asp:Label ID="VideoIDLabel" runat="server" Text='<%# Eval("VideoID") %>' Visible="false" />
...
<br /></span>
     ...
     <asp:SqlDataSource ID="PostCommentDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SecurityConnectionString %>" SelectCommand="SELECT top 2 * FROM [VideoComments] WHERE ([VideoID] = @VideoID) ORDER BY [CommentDate]" OnSelecting="PostCommentDataSource_Selecting">
                 <SelectParameters>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" OnSelecting="SqlDataSource1_Selecting" ConnectionString="<%$ ConnectionStrings:SecurityConnectionString %>" SelectCommand="SELECT * FROM [VideoStore] WHERE ([VideoID] = @VideoID)">
        <SelectParameters>
            <asp:Parameter Name="VideoID" Type="Object" />
        </SelectParameters>
    </asp:SqlDataSource>
