<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="race-list_m.aspx.cs" Inherits="Default3" %>
      ...
      <div class="clearfix grpelem" id="u599"><!-- group -->
       <div class="clearfix grpelem" id="u600"><!-- group -->
        <div class="clearfix grpelem" id="pu603"><!-- column -->
         ...
         <div class="rounded-corners shadow colelem" id="u603" style="
    margin-left: -5px;
    margin-top: -5px;
"><!-- column -->
 ...
 <ContentTemplate>
             <asp:ListView ID="ListView1" runat="server" DataKeyNames="PhotoID,LikeId,UserId,ContentType" DataSourceID="RacePostDataSource" OnItemDataBound="ListView1_ItemDataBound" OnItemCreated="ListView1_ItemCreated" OnItemCommand="ListView1_ItemCommand">
...
" />
            ...
            <div class="colelem post_section_list">
                    <asp:TextBox ID="RacePostTextBox" runat="server" Text='<%# Bind("Post") %>' BorderWidth="1" BorderStyle="Solid" BorderColor="Black" onkeyup="setHeight(this)" Width="573" TextMode="MultiLine" />
                   <br /></div>
...
<br />
                                ...
                                <asp:Label ID="Label3" runat="server" style="margin-bottom: 20px;display: block;margin-top: 5px;" Text='<%# Eval("Post") %>' /><br />
   <asp:ListView ID="ListView3" runat="server" DataKeyNames="PhotoID,LikeId,CommentUserId" DataSourceID="MediaDS" InsertItemPosition="LastItem" OnItemInserting="lvMediaComment_ItemInserting" OnItemCreated="ListViewMediaComment_ItemCreated" OnItemCommand="ListViewMediaComment_ItemCommand">
...
<br /></span>
            ...
            <Parallel AnimationTarget="PanelComment" Duration="3" Fps="25">
                ...
                <FadeIn AnimationTarget="PanelComment" minimumOpacity=".1" Fps="30" />  
                       ...
                       <%--<div class="_u603 f3s_bot" id="_u603-f3s_bot"></div>--%>
                        ...
                        <asp:Panel ID="PanelComment" runat="server" style="margin-top: -15px;margin-left: 4px;">
 <asp:ListView ID="ListViewPostComment" runat="server" DataKeyNames="PhotoID,LikeId,CommentUserId" DataSourceID="MediaDS" InsertItemPosition="LastItem" OnItemInserting="lvMediaComment_ItemInserting" OnItemCreated="ListViewPostComment_ItemCreated" OnItemCommand="ListViewPostComment_ItemCommand">
            ...
            <EditItemTemplate>
                ...
                <br />
                RaceComment:
                <asp:TextBox ID="RaceCommentTextBox" class='animated' TextMode="MultiLine" style="width:490px" runat="server" Text='<%# Bind("Comment") %>' />
                <br />
                RaceCommentUser:
                <asp:TextBox ID="RaceCommentUserTextBox" runat="server" Text='<%# Bind("CommentUser") %>' />
                <br />
            ...
            <InsertItemTemplate>
               ...
               <%-- <br />CommentContentType:
                ...
                <div class="comment_new_section">
                    ...
                    <asp:TextBox ID="RaceCommentTextBox" class='animated' placeholder="Write Comment..." onfocus="this.placeholder=''" onblur="this.placeholder='Write Comment...'" runat="server" TextMode="MultiLine" runat="server" Text='<%# Bind("RaceComment") %>' style="width:490px;" />
...
<br /></span>
  ...
  <div class="bounce3"></div>
    ...
    margin-top: 4px;
"><!-- column -->
              <div id="listgrid_bar" style="width: 135px;	margin-left: 18px; margin-top: -5px;	position: relative;    float:left;">
         <asp:ImageButton ID="ImageButtonGrid" runat="server" CssClass="" ImageUrl="~/images/icon/black/horizontal20.png" OnClick="ImageButtonGrid_Click" Height="40px" Width="40px"   />
           ...
           <asp:ImageButton ID="btnChangeBackground" runat="server" Height="40" Width="40" Text="Change Background" ImageUrl="~/images/icon/black/photo146.png"  />

      <asp:Panel ID="pnChangeBackground" OnClientClick="$('html').css('overflow', 'hidden');" runat="server" CssClass="popup2" Style="display:none;">
