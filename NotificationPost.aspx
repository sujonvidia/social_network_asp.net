<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="NotificationPost.aspx.cs" Inherits="Default4" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <ContentTemplate>
   ...
   <asp:ListView ID="ListView1" runat="server" DataKeyNames="PhotoID,LikeId,UserId" DataSourceID="SqlDataSource1"  OnItemCreated="ListView1_ItemCreated" OnItemCommand="ListView1_ItemCommand">
...
<br /></span>
     ...
     <asp:SqlDataSource ID="PostCommentDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SecurityConnectionString %>" SelectCommand="SELECT top 2 * FROM [UserComments] WHERE ([PostId] = @PostId) ORDER BY [CommentDate]" OnSelecting="PostCommentDataSource_Selecting">
                 <SelectParameters>
