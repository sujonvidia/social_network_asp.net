...
public class AutoComplete : System.Web.Services.WebService {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
         ...
         String strCn = "Data Source=NAYEEM;AttachDbFilename=|DataDirectory|\\SECURITYDB.MDF;Integrated Security=True";
        ...
        //-----I Defined a parameter instead of passing value directly to prevent sql injection--------//
         cmd.CommandText = "select * from UserProfiles Where [FullName] like @myParameter";
       ...
       String  dbValues;
        ...
        foreach (DataRow row  in dt.Rows)
        {
            ...
            dbValues = row["FullName"].ToString();
