<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="covert-list_bookmark.aspx.cs" Inherits="Default5" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_left_menu" Runat="Server">
    <asp:DropDownList ID="DropDownList1" BackColor="#525461" ForeColor="White" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
...
<%--                 <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/images/icon/black/attach.png" Width="20" OnClientClick=" clk();" />--%>
      ...
      <asp:TextBox ID="txtNewPost" runat="server" Columns="40" Rows="2" style="overflow:hidden" onkeyup="setHeight(this)" TextMode="MultiLine" Width="430px" EnableViewState="False"></asp:TextBox>
         <div style="float:left; display:inline;">
           Post By:<asp:TextBox ID="txtPostedby" runat="server" Width="150px" BorderColor="#FF3399" BorderWidth="1px" 
          ...
          <td runat="server" >&nbsp;</td>
           ...
           <div class="position_content">
            <div class=" colelem post_profile_photo">
               ...
               <div class="post_top_info">
               <div style="float:right;margin-right:-10px;">
              <asp:ImageButton ID="BookmarkButton" ImageUrl="~/images/icon/gray/bookmark.png" Width="20" runat="server" CommandName="Bookmarkpost" AlternateText="Bookmark" />

              <asp:ImageButton ID="EditButton" ImageUrl="~/images/icon/gray/edit.png" Width="20" runat="server" CommandName="Edit" AlternateText="Edit" />
              <asp:ImageButton ID="DeleteButton" ImageUrl="~/images/icon/gray/delete.png" Width="20" runat="server" CommandName="Deletepost" AlternateText="Delete" />
...
<br /></span>
          ...
          <td runat="server" >&nbsp;&nbsp;</td>
           ...
           <asp:SqlDataSource ID="CovertDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SecurityConnectionString %>" OnSelecting="CovertDataSource_Selecting" SelectCommand="SELECT CovertBookmark.CovertId, CovertBookmark.UserId, CovertBookmark.Date, CovertPosts.CovertId AS Expr1, CovertPosts.CovertPost, CovertPosts.CovertPostDate, CovertPosts.CovertPostUser, CovertPosts.UserId AS Expr2, CovertPosts.CovertContent, CovertPosts.CovertContentType, CovertPosts.CovertAvatar, CovertPosts.LikeId, CovertPosts.DislikeId, CovertPosts.Category, CovertPosts.LikeCount FROM CovertPosts INNER JOIN CovertBookmark ON CovertPosts.CovertId = CovertBookmark.CovertId WHERE (CovertBookmark.UserId = @UserId) ORDER BY CovertBookmark.Date DESC">
               <SelectParameters>
     ...
     <div class="clearfix grpelem" id="covert_side_menu"><!-- group -->
         <div>
...
TargetControlID="btnChangeBackground"   CancelControlID="btnbckcancel"                                    
      ...
      <div class="clearfix grpelem" id="side_menu_list"><!-- column -->
