<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="covert-list_m.aspx.cs" Inherits="Default3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
     <%--<link rel="stylesheet" type="text/css" href="css/covert.css?3910687529" id="pagesheet3"/>--%>
 ...
 ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>
      ...
      <div class="clearfix colelem" id="u756"><!-- group -->
       <div class="museBGSize grpelem">
            <asp:Image ID="ImageProfile" runat="server" style="height:116px;width:130px;margin-top: -5px;" CssClass="profilephotoborder" /> 
...
EnableViewState="False" />--%>
         ...
         <div style="float:left; display:inline; position:relative; width: 130px; height:35px;margin-top: 10px;margin-left: -460px;margin-bottom: 10px;">
...
"></video>
            ...
            <div class="colelem post_section_list" style="width: 573px;">
                   <asp:TextBox ID="CovertPostTextBox" runat="server" Text='<%# Bind("Post") %>' BorderWidth="1" BorderStyle="Solid" BorderColor="Black" onkeyup="setHeight(this)" Width="573" TextMode="MultiLine" />
                   <br /></div>
...
">
       ...
       <OnClick>
            ...
            <Parallel AnimationTarget="items" Duration="1" Fps="30">
                ...
                <video runat="server" id="videoplayer" style="width: 570px;" controls="controls" src='<%# Eval("ImageUrl") %>' width="534" height="300"></video>
...
<br />
                                ...
                                <asp:Label ID="Label2" runat="server" style="margin-bottom: 20px;display: block;margin-top: 5px;" Text='<%# Eval("Post") %>' /><br />
                              
                               <asp:ListView ID="ListView3" runat="server" DataKeyNames="CommentId,LikeId" DataSourceID="MediaDS" InsertItemPosition="LastItem" OnItemInserting="lvMediaComment_ItemInserting" OnItemCreated="ListView2_ItemCreated" OnItemCommand="ListView2_ItemCommand">
             ...
             <InsertItemTemplate>
                ...
                <span style="">
                   <div class="colelem comment_new_full" style="margin-top:-7px;width:593px;">
...
<br /></span>
  ...
  <div class="bounce3"></div>
     ...
     <div class="clearfix grpelem" id="divider_right_covert" style="margin-top: 20px;margin-left: 610px;"><!-- group -->
...
TargetControlID="btnChangeBackground"                                      
      ...
      <div class="clearfix grpelem" id="side_menu_list" style="margin-top: 120px;margin-left: -6px;"><!-- column -->
