<%@ WebHandler Language="C#" Class="ThumbnailHandlerRaceMedia" %>

using System;
using System.Web;

public class ThumbnailHandlerRaceMedia : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            while (rdr.Read())
            {
                ...
                System.IO.MemoryStream ms = new System.IO.MemoryStream((byte[])rdr["RaceContent"]);
