    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            while (rdr.Read())
            {
                ...
                System.IO.MemoryStream ms = new System.IO.MemoryStream((byte[])rdr["BackgroundPicture"]);
                System.Drawing.Image image = System.Drawing.Image.FromStream(ms);
                // create the actual thumbnail image
                System.Drawing.Image thumbnailImage = image.GetThumbnailImage(2200, 1226, new System.Drawing.Image.GetThumbnailImageAbort(ThumbnailCallback), IntPtr.Zero);
